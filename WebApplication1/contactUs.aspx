<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="contactUs.aspx.cs" Inherits="WebApplication1.WebForm9" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="py-3 py-md-5 py-xl-8">
      ...
      <div class="container">
        <div class="row ">
          <div class="col-12 ">
            <div class="card border  rounded overflow-hidden shadow">
              <div class="card-body p-0">
                <div class="row gy-3 gy-md-4 gy-lg-0">
                  <div class="col-12 col-lg-6 bsb-overlay background-position-center background-size-cover" style="--bsb-overlay-opacity: 0.7; background-image: linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)), url('./images/blood donation image.png');">
                          ...
                          <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                            <div class="col-12">
                              <label for="fullname" class="form-label">Full Name <span class="text-danger">*</span></label>
                               <asp:TextBox ID="txtFullName" CssClass="form-control" runat="server" Placeholder="Enter Full Name" />
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                              ...
                              <div class="input-group">
                                ...
                                <asp:TextBox ID="txtPhone" CssClass="form-control" runat="server" Placeholder="Enter Phone no." />
                              </div>
                            </div>
                            <div class="col-12">
                              <label for="subject" class="form-label">Subject <span class="text-danger">*</span></label>
                              <asp:TextBox ID="txtSubject" CssClass="form-control" runat="server" Placeholder="Enter Subject" />
                            </div>
                            <div class="col-12">
                              <label for="message" class="form-label">Message <span class="text-danger">*</span></label>
                              <textarea ID="txtMessage" class="form-control" runat="server" rows="3" placeholder="Enter Message"></textarea>
                            </div>
                            <div class="col-12">
                              <div class="d-grid">
                               <asp:Button ID="btnSend" CssClass="btn btn-success btn-lg" Text="Send Message" runat="server" OnClick="btnSend_Click"/>
                              </div>
                            </div>
                          </div>
                        </form>
